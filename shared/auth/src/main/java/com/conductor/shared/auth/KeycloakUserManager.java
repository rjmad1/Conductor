...
/**
 * Contract for Keycloak user provisioning operations used by the identity module. Implemented by
 * KeycloakAdminService in platform:tenant. This interface exists to break the compile-time
 * dependency between platform:identity and platform:tenant.
 */
