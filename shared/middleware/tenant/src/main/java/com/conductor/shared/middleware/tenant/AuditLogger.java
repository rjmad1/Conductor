...
public class AuditLogger {
    ...
    public void logEvent(String action, String resource, String outcome, String details) {
        ...
        log.info("timestamp={} tenantId={} userId={} serviceId={} requestId={} action={} resource={} outcome={} details=\"{}\"",
                timestamp, tenantIdStr, userIdStr, serviceId, requestId, action, resource, outcome, details);
    }
}
