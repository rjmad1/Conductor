...
/**
 * Evaluates condition expressions against an execution context.
 * Supports comparison operators, existence checks, and boolean combinators (AND/OR/NOT).
 * Variables are resolved from the execution context's variables map using dot-notation paths.
 */
public class ConditionEvaluator {
    ...
    /**
     * Resolves a dot-notation variable path from the variables map.
     * E.g., "contact.email" resolves variables.get("contact") -> map.get("email").
     */
    @SuppressWarnings("unchecked")
