...
class ConditionEvaluatorTest {
    ...
    void equalsTrue() {
        Condition c = Condition.builder().field("status").operator(Operator.EQUALS).value("active").build();
    ...
    void equalsFalse() {
        Condition c = Condition.builder().field("status").operator(Operator.EQUALS).value("inactive").build();
    ...
    void notEquals() {
        Condition c = Condition.builder().field("status").operator(Operator.NOT_EQUALS).value("inactive").build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
    ...
    void contains() {
        Condition c = Condition.builder().field("email").operator(Operator.CONTAINS).value("@example").build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
    ...
    void greaterThan() {
        Condition c = Condition.builder().field("amount").operator(Operator.GREATER_THAN).value("100").build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
    ...
    void lessThan() {
        Condition c = Condition.builder().field("amount").operator(Operator.LESS_THAN).value("1000").build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
    ...
    void andAllTrue() {
        Condition c = Condition.builder()
                ...
                .children(List.of(
                        ...
                        Condition.builder().field("amount").operator(Operator.GREATER_THAN).value("0").build()
                ))
                .build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
    ...
    void andOneFalse() {
        Condition c = Condition.builder()
                ...
                .children(List.of(
                        Condition.builder().field("status").operator(Operator.EQUALS).value("active").build(),
                        Condition.builder().field("amount").operator(Operator.GREATER_THAN).value("1000").build()
                ))
                .build();
        assertThat(evaluator.evaluate(c, context)).isFalse();
    }
    ...
    void dotNotationResolution() {
        Condition c = Condition.builder().field("nested.field").operator(Operator.EQUALS).value("value").build();
        assertThat(evaluator.evaluate(c, context)).isTrue();
    }
