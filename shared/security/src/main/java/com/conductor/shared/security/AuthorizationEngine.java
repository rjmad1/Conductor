...
public class AuthorizationEngine {
    ...
    /**
     * Checks if the active authenticated context has the requested permission.
     * Enforces deny-by-default.
     * Wildcards (e.g., "workflows:*") are supported.
     */
    ...
    /**
     * Checks if the authenticated tenant matches the target resource owner.
     * Used for resource-level ABAC checks.
     */
