...
/**
 * Canonical NATS subject constants for all customer domain events. Subject pattern:
 * conductor.{tenantId}.customer.{entity}.{action} These constants define the {entity}.{action}
 * suffix portion.
 */
