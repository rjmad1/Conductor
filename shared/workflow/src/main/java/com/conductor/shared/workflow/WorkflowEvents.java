...
/**
 * Constants for workflow domain event subject suffixes.
 * Full subject format: conductor.{tenantId}.workflow.{entity}.{action}
 * Compliant with EVENT_GOVERNANCE.md naming convention.
 */
