...
public class CredentialService {
  ...
  public Credential saveCredential(UUID integrationId, String authType, String rawPayload) {
    ...
    Optional<Credential> existing =
        credentialRepository.findByIntegrationIdAndTenantId(integrationId, tenantId);
    ...
    auditLogger.logEvent(
        ...
        "SUCCESS",
        "Credential saved for authType: " + authType);
    return saved;
  }
  ...
  @Transactional
  public OAuthConnection saveOAuthConnection(
      UUID integrationId,
      String accessToken,
      String refreshToken,
      Instant expiresAt,
    ...
    Optional<OAuthConnection> existing =
        oauthConnectionRepository.findByIntegrationIdAndTenantId(integrationId, tenantId);
  ...
  public void rotateCredential(UUID integrationId, String newRawPayload) {
    ...
    auditLogger.logEvent(
        "CREDENTIAL_ROTATED", "integration:" + integrationId, "SUCCESS", "Rotated key credential");
  }
