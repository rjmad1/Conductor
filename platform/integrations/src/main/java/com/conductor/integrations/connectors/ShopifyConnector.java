...
public class ShopifyConnector implements ConnectorAdapter {
    ...
    public ShopifyConnector(
            ...
            @Value("${connector.shopify.health-url:https://status.shopify.com/api/v2/status.json}") String healthCheckUrl,
    ...
    @Override
    public String getConnectorType() { return "shopify"; }
    ...
    public void subscribe(UUID tenantId, String eventName, String webhookUrl) {
        ...
        auditLogger.logEvent("WEBHOOK_SUBSCRIBED", "shopify:" + eventName, "SUCCESS", "Subscribed: " + webhookUrl);
    }

    @Override
    public void unsubscribe(UUID tenantId, String eventName) {
        log.info("Unsubscribing from Shopify webhook {} for tenant {}", eventName, tenantId);
        auditLogger.logEvent("WEBHOOK_UNSUBSCRIBED", "shopify:" + eventName, "SUCCESS", "Unsubscribed");
    }
