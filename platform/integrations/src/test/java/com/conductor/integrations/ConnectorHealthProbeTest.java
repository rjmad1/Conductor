...
class ConnectorHealthProbeTest {
  ...
  void setUp() {
    ...
    metrics = new IntegrationMetrics(registryProvider);
    ...
    razorpayConnector =
        new RazorpayConnector(
            ...
            logger,
            metrics,
            "http://localhost/razorpay-health",
            500,
            500);
    zohoConnector =
        new ZohoConnector(
            proxyHttpClient, publisher, logger, metrics, "http://localhost/zoho-health", 500, 500);
  }
