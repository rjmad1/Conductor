...
public class IntegrationsArchBoundaryTest {
  ...
  @ArchTest
  public static final ArchRule integrationsLayerBoundaries =
      layeredArchitecture()
          .consideringAllDependencies()
          .layer("Integrations")
          .definedBy("com.conductor.integrations..")
          .optionalLayer("Workflow")
          .definedBy("com.conductor.workflow..")
          .optionalLayer("Customer")
          .definedBy("com.conductor.customer..")
          .whereLayer("Workflow")
          .mayOnlyBeAccessedByLayers("Workflow")
          .whereLayer("Customer")
          .mayOnlyBeAccessedByLayers("Customer");
