...
class TenantIsolationTest {
    ...
    @MockBean
    private com.conductor.customer.service.ContactService contactService;

    @MockBean
    private com.conductor.customer.service.ConsentService consentService;

    @MockBean
    private com.conductor.customer.service.TagService tagService;

    @MockBean
    private com.conductor.customer.service.SegmentService segmentService;

    @MockBean
    private com.conductor.customer.service.CustomerTimelineService timelineService;

    @MockBean
    private com.conductor.shared.messaging.NatsConnectionManager natsConnectionManager;

    @MockBean
    private com.conductor.shared.messaging.EventConsumer eventConsumer;

    @MockBean
    private com.conductor.shared.messaging.EventObservability eventObservability;
    ...
    @MockBean
    private com.conductor.customer.service.StopUnsubscribeListener stopUnsubscribeListener;
    ...
    void givenActiveTenant_whenGetCrossTenantCustomer_thenReturn404() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/customers/" + crossTenantCustomerId)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON))
