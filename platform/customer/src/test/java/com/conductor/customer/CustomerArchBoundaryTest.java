...
public class CustomerArchBoundaryTest {
  ...
  @ArchTest
  public static final ArchRule noAccessToIdentity =
      noClasses()
          .that()
  ...
  @ArchTest
  public static final ArchRule noAccessToWorkflow =
      noClasses()
          .that()
          .resideInAPackage("com.conductor.customer..")
          .should()
  ...
  @ArchTest
  public static final ArchRule noAccessToIntegrations =
      noClasses()
          .that()
          .resideInAPackage("com.conductor.customer..")
          .should()
  ...
  @ArchTest
  public static final ArchRule noAccessToAnalytics =
      noClasses()
          .that()
          .resideInAPackage("com.conductor.customer..")
          .should()
  ...
  @ArchTest
  public static final ArchRule noAccessToAi =
      noClasses()
          .that()
          .resideInAPackage("com.conductor.customer..")
          .should()
          .dependOnClassesThat()
          .resideInAPackage("com.conductor.ai..");
}
