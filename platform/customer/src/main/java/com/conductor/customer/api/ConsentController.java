...
public class ConsentController {
  ...
  public ResponseEntity<ConsentResponse> grantConsent(
      @PathVariable UUID customerId, @Valid @RequestBody GrantConsentRequest request) {
  ...
  public ResponseEntity<ConsentResponse> revokeConsent(
      @PathVariable UUID customerId, @Valid @RequestBody RevokeConsentRequest request) {
    ConsentRecord record =
  ...
  @GetMapping
  public ResponseEntity<List<ConsentStatusResponse>> getConsentStatus(
      @PathVariable UUID customerId) {
    List<ConsentStatusResponse> statuses =
  ...
  public ResponseEntity<List<ConsentResponse>> getConsentHistory(@PathVariable UUID customerId) {
    List<ConsentResponse> history =
        consentService.getConsentHistory(customerId).stream()
            .map(this::toResponse)
            .collect(Collectors.toList());
  ...
  public record ConsentStatusResponse(ConsentType consentType, boolean isActive) {}
