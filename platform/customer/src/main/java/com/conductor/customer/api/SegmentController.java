...
public class SegmentController {
    ...
    public ResponseEntity<List<SegmentResponse>> listSegments() {
        List<SegmentResponse> responses = segmentService.listSegments()
                .stream()
                .map(this::toResponse)
    ...
    public ResponseEntity<SegmentResponse> updateSegment(@PathVariable UUID id, @Valid @RequestBody UpdateSegmentRequest request) {
        Segment segment = segmentService.updateSegment(
                id,
                request.name(),
                request.rules(),
                request.description()
    ...
    public ResponseEntity<List<CustomerSegmentResponse>> getCustomerSegments(@PathVariable UUID customerId) {
        List<CustomerSegmentResponse> segments = segmentService.getCustomerSegments(customerId)
                .stream()
    ...
    public ResponseEntity<Void> addCustomerToSegment(@PathVariable UUID id,
    ...
    public ResponseEntity<Void> removeCustomerFromSegment(@PathVariable UUID id,
    ...
    public ResponseEntity<Void> recomputeSegment(@PathVariable UUID id,
