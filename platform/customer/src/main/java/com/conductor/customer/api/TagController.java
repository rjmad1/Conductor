...
public class TagController {
    ...
    @GetMapping("/tags")
    public ResponseEntity<List<TagResponse>> listTags(@RequestParam(required = false) String category) {
        List<Tag> tags = (category != null) ? tagService.listTagsByCategory(category) : tagService.listTags();
    ...
    @PutMapping("/tags/{id}")
    public ResponseEntity<TagResponse> updateTag(@PathVariable UUID id, @Valid @RequestBody UpdateTagRequest request) {
    ...
    public ResponseEntity<List<CustomerTagResponse>> getCustomerTags(@PathVariable UUID customerId) {
        List<CustomerTagResponse> tags = tagService.getCustomerTags(customerId)
                .stream()
    ...
    public ResponseEntity<Void> assignTag(@PathVariable UUID customerId,
    ...
    public ResponseEntity<Void> removeTag(@PathVariable UUID customerId,
