...
public class TimelineController {
    ...
    public ResponseEntity<Page<TimelineResponse>> getTimeline(
        ...
        if (type != null) {
            ...
            List<TimelineResponse> mapped = list.stream().map(this::toResponse).collect(Collectors.toList());
        ...
        Page<TimelineResponse> page = timelineService.getTimeline(customerId, pageable).map(this::toResponse);
