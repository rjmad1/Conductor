...
/** Assignment record linking a Tag to a Customer. Unique per (tenant_id, customer_id, tag_id). */
@Entity
@Table(
    name = "customer_tags",
    indexes = {
      ...
      @Index(
          name = "idx_customer_tags_unique",
          columnList = "tenant_id, customer_id, tag_id",
          unique = true)
    })
@Getter
@Setter
