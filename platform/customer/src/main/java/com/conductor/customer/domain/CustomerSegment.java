...
/**
 * Membership record linking a Customer to a Segment. Source indicates whether the customer was
 * added manually or by the rule engine.
 */
@Entity
@Table(
    ...
    indexes = {
      ...
      @Index(
          name = "idx_customer_segments_unique",
          columnList = "tenant_id, customer_id, segment_id",
          unique = true)
    })
@Getter
@Setter
