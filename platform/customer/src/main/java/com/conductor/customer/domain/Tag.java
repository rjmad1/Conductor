...
/**
 * A label that can be applied to customers.
 * Tags are tenant-scoped and categorised.
 * slug is a URL-safe unique identifier within the tenant (e.g. "vip", "churn-risk").
 */
@Entity
