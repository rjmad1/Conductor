...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> mergeCustomers(@PathVariable UUID id, @RequestParam UUID targetId) {
    ...
    public ResponseEntity<List<CustomerResponse>> searchCustomers(
        ...
        List<CustomerResponse> results = customerSearchService.search(phone, email, name, tagId, segmentId)
                .stream()
                .map(this::toResponse)
