...
/**
 * Seeds default KPI definitions on first startup if none exist. These represent the 7 core platform
 * KPIs specified in the analytics requirements.
 */
@Component
public class DefaultKpiInitializer {
  ...
  public void seedDefaults() {
    ...
    createKpi(
        ...
        80.0,
        "platform");
    createKpi("Active Tenants", "active_tenants", MetricAggregation.COUNT, 1.0, 0.0, "platform");
    createKpi(
        "Customer Growth", "customer_growth", MetricAggregation.COUNT, null, null, "platform");
    createKpi(
        "Active Customers", "active_customers", MetricAggregation.COUNT, null, null, "platform");
    createKpi("Response Rate", "response_rate", MetricAggregation.RATE, 50.0, 25.0, "platform");
