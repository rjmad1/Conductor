...
/**
 * Generates signed JWT tokens for Metabase interactive iframe embedding. Per ADR-008, the JWT locks
 * the tenant_id parameter to prevent cross-tenant data access.
 *
 * <p>Security: The METABASE_EMBEDDING_SECRET must be rotated regularly per
 * SECRETS_MANAGEMENT_STANDARD.
 */
@Service
