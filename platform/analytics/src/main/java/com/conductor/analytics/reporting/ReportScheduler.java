...
/**
 * Scheduled task that triggers execution of reports marked as SCHEDULED.
 * Runs every minute and checks for due reports based on their cron expression.
 *
 * ponytail: Simplified cron matching — checks all SCHEDULED reports on each tick.
 * For production scale, implement a proper cron evaluator or use Spring's CronExpression.
 */
@Component
