...
/**
 * Report service for creating, executing, and exporting analytics reports.
 * All operations are tenant-scoped and auditable.
 */
@Service
public class ReportService {
    ...
    public byte[] executeAndExport(UUID reportId) {
        ...
        return switch (report.getOutputFormat().toUpperCase()) {
            ...
            default -> throw new IllegalArgumentException("Unsupported format: " + report.getOutputFormat());
        };
    }
