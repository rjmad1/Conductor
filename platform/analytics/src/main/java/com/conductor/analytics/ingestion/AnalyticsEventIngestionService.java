...
/**
 * Subscribes to all Conductor NATS domain event streams and ingests them into ClickHouse.
 * Uses global (system-level) subscriptions without tenant scoping to capture all events.
 *
 * Consumed event domains: tenant, identity, customer, workflow, messaging, integration, audit, ai
 */
@Service
public class AnalyticsEventIngestionService {
    ...
    public AnalyticsEventIngestionService(EventConsumer eventConsumer, ClickHouseWriter clickHouseWriter) {
    ...
    private void handleEvent(ConductorEvent<String> event, String domain, String entity, String action) {
