...
/**
 * Batch writer for ClickHouse analytics events.
 * Buffers events in memory and flushes when batch size or time interval is reached.
 * Idempotent: uses event_id to prevent duplicate insertion at query level.
 */
@Component
public class ClickHouseWriter {
    ...
    void startFlushScheduler() {
        ...
        log.info("ClickHouseWriter started with batchSize={} flushInterval={}ms", batchSize, flushIntervalMs);
    }
