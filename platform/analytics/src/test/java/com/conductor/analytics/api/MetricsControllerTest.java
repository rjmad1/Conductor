...
class MetricsControllerTest {
    ...
    @MockBean
    private WorkflowMetricsService workflowMetrics;
    @MockBean
    private MessagingMetricsService messagingMetrics;
    @MockBean
    private CustomerMetricsService customerMetrics;
    @MockBean
    private IntegrationMetricsService integrationMetrics;
    @MockBean
    private TenantMetricsService tenantMetrics;

    @Test
    void unauthenticatedRequestReturns401() throws Exception {
        mockMvc.perform(get("/api/v1/analytics/metrics/workflow"))
    ...
    void authenticatedMessagingMetricsReturns200() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/analytics/metrics/messaging"))
                .andExpect(status().isOk());
    }
}
