...
/**
 * Persistent workflow definition entity.
 * Contains the JSON DSL definition, trigger configuration, and version lifecycle state.
 * Extends TenantAwareEntity for automatic row-level tenant isolation.
 */
@Entity
