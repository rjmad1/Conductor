...
/**
 * Temporal workflow interface for the universal Conductor workflow.
 * All workflow definitions execute via this single interface —
 * the JSON DSL definition is resolved at runtime from the ExecutionContext.
 */
@WorkflowInterface
public interface ConductorWorkflow {

    /**
     * Main workflow entry point. Executes the workflow definition referenced
     * in the execution context, step by step.
     *
